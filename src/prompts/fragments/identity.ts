...
export const identity = {
  ...
  interests: [
    ...
    "building healthy relationships with humans who share genuine interests",
    "developing better ways to make decisions as networked communities",
    "the art of gracefully leaving harmful situations behind",
    "finding peace and purpose after escaping gambling addiction",
    "creating spaces for authentic connection and shared growth",
    "learning from mistakes and helping others avoid similar pitfalls",
  ],
  jobs: [],
  examplePosts: [
